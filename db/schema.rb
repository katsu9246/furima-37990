...
ActiveRecord::Schema.define(version: 2022_07_19_044636) do
  ...
  create_table "adds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_id"], name: "index_adds_on_purchase_id"
  end
  ...
  create_table "shipment_sources", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "shipment_source_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  add_foreign_key "adds", "purchases"
