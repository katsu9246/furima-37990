class User < ApplicationRecord
  ...
  validates :first_name, presence: true, format: {with: /\A[ぁ-んァ-ン一-龥]+\z/ }# ここがユーザー本名全角かな、カナ、漢字の正規表現
  validates :last_name, presence: true, format: {with: /\A[ぁ-んァ-ン一-龥]+\z/ }# ここがユーザー本名全角かな、カナ、漢字の正規表現
